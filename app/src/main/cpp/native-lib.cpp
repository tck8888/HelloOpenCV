...
Java_com_tck_opencvandroidtrain_ImageHandlerUtils_flip(JNIEnv *env, jobject thiz, jobject bitmap_in,
                                                       jobject bitmap_out) {
    Mat src;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_tck_opencvandroidtrain_ImageHandlerUtils_blur(JNIEnv *env, jobject thiz, jobject bitmap_in,
